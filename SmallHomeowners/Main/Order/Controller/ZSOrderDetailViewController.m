...
@property (nonatomic, strong) UIButton      *billDetailButton;  //账单详情
...
//    [self.topHeaderView addSubview:self.noticeLabel];
    ...
    [self.billDetailButton setTitle:@"账单详情 >" forState:UIControlStateNormal];
    ...
    self.callMediationBtn.frame = CGRectMake(self.stateImageView.right+10,  self.stateLabel.bottom+5, 150, 30);
...
- (void)configureTable
{
    ...
    [self.tableView registerClass:[ZSOrderDeatilPhotoCell class] forCellReuseIdentifier:@"ZSOrderDeatilPhotoCell"];
}
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    sectionView.leftLab.text = @[@"人员信息",[NSString stringWithFormat:@"%@信息",[ZSGlobalModel changeLoanString:@"贷款"]],@"房产信息",@"征信信息",@"订单信息"][section];
