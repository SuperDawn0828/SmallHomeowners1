...
@class ZSSLDataCollectionView;
@class ZSDataCell;

@protocol ZSSLDataCollectionViewDelegate <NSObject>
...
@interface ZSSLDataCollectionView : UIView
...
@property (nonatomic,weak)id <ZSSLDataCollectionViewDelegate> delegate;
