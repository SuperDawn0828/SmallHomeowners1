...
- (id)initWithFrame:(CGRect)frame withClickAction:(NSString *)leftTitle
{
    if (self = [super initWithFrame:frame]) {
        ...
        if ([leftTitle containsString:@"*"]) {
            ...
            [mutableStr addAttribute:NSForegroundColorAttributeName value:ZSColorGolden range:NSMakeRange(leftTitle.length-1, 1) ];
        ...
        self.rightLabel = [[UILabel alloc]initWithFrame:CGRectMake(145, 0, ZSWIDTH-145-30, self.height)];
        ...
        self.lineView = [[UIView alloc]initWithFrame:CGRectMake(15, 0, ZSWIDTH, 0.5)];
   ...
   withKeyboardType:(UIKeyboardType)keyType
{
    if (self = [super initWithFrame:frame])
    {
        ...
        self.inputTextFeild = [[UITextField alloc]initWithFrame:CGRectMake(160, 0, ZSWIDTH-160-15, self.height)];
        ...
        self.inputTextFeild.keyboardType = keyType ? keyType : UIKeyboardTypeDefault;//设置键盘类型
           ...
           withKeyboardType:(UIKeyboardType)keyType
{
    if (self = [super initWithFrame:frame])
    {
        ...
        //输入框
        self.inputTextView = [[UITextView alloc]initWithFrame:CGRectMake(115, 0, ZSWIDTH-115-15, self.height)];
     ...
     withElement:(NSString *)title
{
    if (self = [super initWithFrame:frame])
    {
        ...
        self.inputTextFeild = [[UITextField alloc]initWithFrame:CGRectMake(160, 0, ZSWIDTH-160-15-20, self.height)];
        self.inputTextFeild.textColor = ZSColorListRight;
        self.inputTextFeild.textAlignment = NSTextAlignmentRight;
        self.inputTextFeild.font = [UIFont systemFontOfSize:15];
        self.inputTextFeild.keyboardType = keyType ? keyType : UIKeyboardTypeDefault;//设置键盘类型
...
- (id)initWithFrame:(CGRect)frame withLeftTitle:(NSString *)leftTitle withRightTitle:(NSString *)rightTitle
{
    if (self = [super initWithFrame:frame])
    {
        ...
        //右侧的内容
        self.rightLabel = [[UILabel alloc]initWithFrame:CGRectMake(115, 0, ZSWIDTH-115-15, self.height)];
        self.rightLabel.font = [UIFont systemFontOfSize:15];
